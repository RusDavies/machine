...
func (provisioner *GenericProvisioner) AdaptDockerOptions() error {

	// Implements a default version of iGenericProvisionerHooks.PostGenerateDockerOptions(),
	// which, by default, does nothing. 
	//
	// However, if distrubution specific tweaks are required to the configuration
	// generated by GenerateDockerOptions(), then the embedding structure should 
	// implement the iGenericProvisionerHooks.PostGenerateDockerOptions() method, 
	// and set provisioner.hooks = &provisioner.  Doing so will, in effect, 
	// override this method, in a virtual dispatch manner. 
	//
	// For an example of usage, see the provisioner for Fedora. 
